...
function activeCoursePrompt(prompt) {
  ...
  return {
    ...
    questionType: state.reviewVariant.questionType || "free_response",
    choices: state.reviewVariant.choices || [],
    correctChoiceIndex: Number.isInteger(state.reviewVariant.correctChoiceIndex) ? state.reviewVariant.correctChoiceIndex : null,
